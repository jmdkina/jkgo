...
func generateHtmlHeader(fo *os.File, title string, prespace int) error {
	...
	html_header := "<!DOCTYPE html>\n" +
		...
		"\t<![endif]-->\n" +
		"\t<script type='text/javascript' src='" + prestr + "add-on/prefix/prefixfree.min.js'></script>\n" +
		"\n" +
		"\t<!-- bootstrap css -->\n" +
		"\t<link href='" + prestr + "add-on/bootstrap/css/bootstrap.min.css' rel='stylesheet'>\n" +
		"\t<link href='" + prestr + "add-on/bootstrap/css/bootstrap-theme.min.css' rel='stylesheet'>\n" +
		"\t<link href='" + prestr + "add-on/bootstrap/css/bootstrap-responsive.min.css' rel='stylesheet'>\n" +
		"</head>\n" +
		"<body>\n" +
		"<div class='container'>\n"
...
func generateHtmlFooter(fo *os.File, prespace int) error {
	...
	html_end := "\n</div>\n" +
		"<!-- load js -->\n" +
		"<script type='text/javascript' src='" + prestr + "add-on/jquery/jquery.min.js'></script>\n" +
		"<script type='text/javascript' src='" + prestr + "add-on/bootstrap/js/bootstrap.min.js'></script>\n" +
		"<div class='text-center'><em><small>Besovideo@2014</small></em></div>" +
		"</body>\n<html>\n"
